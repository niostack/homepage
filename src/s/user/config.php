...
define( 'YOURLS_DB_USER', 'hdm721891548' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'Ap20s32019' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'hdm721891548_db' );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', e.g. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', 'hdm721891548.my3w.com' );
...
define( 'YOURLS_SITE', 'https://945y.cn/s' );

/** YOURLS language
 ** Change this setting to use a translation file for your language, instead of the default English.
 ** That translation file (a .mo file) must be installed in the user/language directory.
 ** See http://yourls.org/translations for more information */
define( 'YOURLS_LANG', 'zh' );
...
define( 'YOURLS_COOKIEKEY', '123qwe123qwe' );
